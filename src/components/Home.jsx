    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!formData.name || !formData.email || !formData.message) {
                ...
                //Call Post API to send Data
                let data = await fetch(`${config.appURL}/contact-us/postContactDetails`, {
                    method: "POST",
                    headers: {
                    ...
                    <div className="mt-8 text-center">
                        <svg className="w-full" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path
                                ...
                                transform="translate(-52 -162.63)" fill="none" stroke="#000" strokeMiterlimit="10"
                                opacity="0.1"/>
                            <path
                ...
                <div className="">
                    <div className="text-right">
                        <button type="button"
                                ...
                                className="text-gray-500 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-500 dark:border-gray-500 dark:text-white dark:hover:bg-gray-500 mr-2 mb-2">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd"
                                      d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z"
                                      clipRule="evenodd"/>
                            </svg>
                            <span className="ml-4 font-sans">Login To Admin</span>
                        </button>
                    </div>
                    <div>
